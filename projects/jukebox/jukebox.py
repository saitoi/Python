...
class DataListBox(Scrollbox):
    ...
    def link(self, widget, link_field):
        """
        Links the widget to the field of
        :param widget: Listbox where content will be displayed
        :param link_field: Current Listbox name
        :return: None
        """
    ...
    def requery(self, link_value=None):
        ...
        if self.link_field == "artist":
            temporary_album = link_value
...
if __name__ == '__main__':
    ...
    :param <<ListboxSelect>>: Event fired when user selects something
    :param get_albums: 
    """
